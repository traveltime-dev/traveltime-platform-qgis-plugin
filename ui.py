...
class ConfigDialog(QDialog):
    ...
    def showEvent(self, *args, **kwargs):
        ...
        # disable https
        self.disableHttpsCheckBox.setChecked(s.value('travel_time_platform/disable_https', False, type=bool))
    ...
    def accept(self, *args, **kwargs):
        ...
        # disable https
        s.setValue('travel_time_platform/disable_https', self.disableHttpsCheckBox.isChecked())
