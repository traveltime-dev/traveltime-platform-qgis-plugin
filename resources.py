...
icon_routes_express = icon("icons/icon_routes_16x16.svg")
...
icon_time_filter_express = icon("icons/icon_time_filter_simple_16x16.svg")
...
icon_time_map_express = icon("icons/icon_time_map_simple_16x16.svg")
