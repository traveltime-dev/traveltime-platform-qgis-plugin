...
<qgis styleCategories="Symbology" version="3.6.3-Noosa">
  <renderer-v2 symbollevels="1" graduatedMethod="GraduatedColor" forceraster="0" type="graduatedSymbol" enableorderby="0" attr="prop_travel_time/60">
    <ranges>
      ...
      <range upper="30.000000000000000" render="true" lower="15.000000000000000" label="15-30 min" symbol="2"/>
      <range upper="60.000000000000000" render="true" lower="30.000000000000000" label="30-60 min" symbol="3"/>
      <range upper="120.000000000000000" render="true" lower="60.000000000000000" label="1-2 hrs" symbol="4"/>
      <range upper="300.000000000000000" render="true" lower="120.000000000000000" label="2-5 hrs" symbol="5"/>
      <range upper="inf" render="true" lower="300.000000000000000" label=">5 hrs" symbol="6"/>
    </ranges>
    <symbols>
      <symbol alpha="1" type="line" clip_to_extent="1" name="0" force_rhr="0">
        <layer class="SimpleLine" enabled="1" pass="6" locked="0">
          ...
          <prop k="line_color" v="245,166,35,255"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="1" force_rhr="0">
        <layer class="SimpleLine" enabled="1" pass="5" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="242,115,82,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="2" force_rhr="0">
        <layer class="SimpleLine" enabled="1" pass="4" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="233,67,129,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="3" force_rhr="0">
        <layer class="SimpleLine" enabled="1" pass="3" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="120,83,161,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="4" force_rhr="0">
        <layer class="SimpleLine" enabled="1" pass="2" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="14,97,189,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="5" force_rhr="0">
        <layer class="SimpleLine" enabled="1" pass="1" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="48,55,154,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" name="6" force_rhr="0">
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="82,13,118,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
    ...
    <colorramp type="gradient" name="[source]">
      <prop k="color1" v="245,166,35,255"/>
      <prop k="color2" v="82,13,118,255"/>
      <prop k="discrete" v="0"/>
      <prop k="rampType" v="gradient"/>
      <prop k="stops" v="0.324519;239,66,127,255:0.657452;13,99,191,255"/>
    </colorramp>
    <mode name="pretty"/>
    <symmetricMode enabled="false" astride="false" symmetryPoint="0" valueForCboPrettyBreaks="26.00/28.00/30.00/32.00/34.00/36.00"/>
    <rotation/>
    <sizescale/>
    <labelformat format="%1-%2 min" decimalplaces="2" trimtrailingzeroes="true"/>
  </renderer-v2>
